    ...
    /*模糊查询*/
     function selectModel() {
         ...
         $('#test').datagrid({
             ...
             nowrap: true,
             striped: true,
             url: '${pageContext.request.contextPath}/Model/getModelDataPageUtil?cartype='+cartype,
             sortName: 'code',
             sortOrder: 'desc',
             align: 'center',
             idField: 'code',
           /*  frozenColumns: [[  //冻结列
            {field: 'id', checkbox: false},//控制复选框是否显示
            ]],*/
             columns: [[ //Column是一个数组对象，它的每个元素也是一个数组。元素数组的元素是一个配置对象，它定义了每个列的字段。
                 {field: 'cartype', title: '车型', width: 100}, //title 标题文本
                 {field: 'announcement', title: '公告号', width: 100 },//field：列的字段名
                 {field: 'mileage', title: '续航里程', width: 100 },
                 {field: 'topspeed', title: '最高车速', width: 100 },
                 {field: 'length', title: '长度', width: 100 },
                 {field: 'width', title: '宽度', width: 100 },
                 {field: 'weigth', title: '重量', width: 100 },
                 {field: 'seatnumber', title: '座位数', width: 100 },
                 {field: 'doornum', title: '门数', width: 100 },
               /*   {
                field: 'opt',
                title: '操作',
                width: 100,
    ...
    //角色列表
       $(function () {
        $('#test').datagrid({
            ...
            nowrap: true,
            striped: true,
            url: '${pageContext.request.contextPath}/Model/getModelDataPageUtil',
            sortName: 'code',
            sortOrder: 'desc',
            align: 'center',
            idField: 'code',
    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-table"></i> <span>车型管理</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="pages/tables/data.jsp"><i class="fa fa-circle-o"></i>车型管理</a></li>
                <li><a href="pages/tables/dataModel.jsp"><i class="fa fa-circle-o"></i>车型管理</a></li>
              </ul>
            </li>
      ...
      <div class="content-wrapper">
        ...
        <form method="post" action="#">
          车型<input type="text" value="${cartype}" id="carname">
          <input type="button" value="查询" onclick="selectModel()">
