  ...
  <script type="text/javascript">
    ...
    $(function () {
        $('#test').datagrid({
            ...
            nowrap: true,
            striped: true,
            url: '${pageContext.request.contextPath}/vehicle/getVehicleDataPageUtil',
            sortName: 'code',
            sortOrder: 'desc',
            align: 'center',
            idField: 'code',
          /*  frozenColumns: [[  //冻结列
            ...
            columns: [[ //Column是一个数组对象，它的每个元素也是一个数组。元素数组的元素是一个配置对象，它定义了每个列的字段。
                {field: 'carlicense', title: '车牌号', width: 100}, //title 标题文本
                {field: 'vin', title: 'VIN', width: 100 },//field：列的字段名
                {field: 'iccid', title: 'ICCID', width: 100 },
                {field: 'cartype', title: '车型', width: 100 },
                {field: 'provinces', title: '省份', width: 100 },
