	...
	<table style="padding: 5px;" width="100%">
		<tr>
			...
			<td valign="bottom" align="right" width="50%">
				<font size="3">&nbsp;&nbsp;<strong>欢迎：</strong><sec:authentication property="name"/>[${userinfo.username}]</font>
			</td>
		</tr>
	</table>
</div>
<div region="center" >
	<div class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="首页" data-options="iconCls:'icon-home'">
			<div align="center" style="padding-top: 100px;"><font color="red" size="10">欢迎</font></div>
		</div>
	</div>
</div>
	...
	<form id="fm" method="post">
		<table cellpadding="8px">
			<tr>
				<td>用户名：</td>
				<td>
					<input type="text" id="userId" name="userId" readonly="readonly" value="" style="width: 200px"/>
				</td>
			</tr>
			<tr>
				<td>原密码：</td>
