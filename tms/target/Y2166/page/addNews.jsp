...
<head>
	...
	<script type="text/javascript">
     ...
     /*  var ue = UE.getEditor('container', {
            toolbars: [
                ['fullscreen','simpleupload', 'undo', 'redo', 'bold']
            ],
		 ...
		 toolbars:[['bold','italic','insertimage','fontfamily',
		 'fontsize','preview','searchreplace','help','drafts']]
		 });
		 }*/
       function add(status) {
...
<div id="container" style="margin-top: 10px;">
	<div class="server">
		...
		<form method="post" id="form1" action="${pageContext.request.contextPath}/user/addNews" enctype="multipart/form-data">
			<table class="table" width="100%">

				<tr>
					<td class="first">所属栏目：</td>
					<td>
						<input class="easyui-textbox"  id="column"  placeHolder="点我查询" readonly="readonly"/>
						<input class="easyui-textbox"  type="text" id="columntype" name="columntype"/>
					</td>
				...
				<tr>
					...
					<td class="input" colspan="3"><input class="easyui-textbox" type="text" name="title" value="" /><input type="hidden" id="sts" name="status" value="" /></td>
				</tr>
				...
				<tr>
					<td  class="easyui-textbox"style="height:60px;" colspan="4">
						<textarea id="summaryeditor" type="text/plain" name="summary" rows="4" cols="100" style="resize:none;width:900px;"></textarea>
						<script type="text/javascript">
				...
				<tr>
					<td colspan="4" style="height:40px;">
						<a href="javascript:add(0);" class="easyui-linkbutton">暂存草稿</a>
						<a href="javascript:add(1);" class="easyui-linkbutton">发布</a>
