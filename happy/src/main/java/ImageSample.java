...
public class ImageSample {
    ...
    private static String accessKeyId = "LTAIRtI3emeL5ibi";
    private static String accessKeySecret = "VtSIO4VZnSrWn67PLBRoc5PWlc6DCQ";
    private static String bucketName = "pictureserver";
    private static String key = "E:/Y2166/happy/src/main/webapp/upload/1.jpg";
